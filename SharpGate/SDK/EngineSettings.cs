...
namespace SDK.Script.EngineSettingsSDK
{
    ...
    {
        public ConsoleSettings(ulong addr) : base(addr) { }
    ...
    {
        public GameMapsSettings(ulong addr) : base(addr) { }
    ...
    {
        public GameNetworkManagerSettings(ulong addr) : base(addr) { }
    ...
    {
        public GameSessionSettings(ulong addr) : base(addr) { }
    ...
    {
        public GeneralEngineSettings(ulong addr) : base(addr) { }
    }
    public class GeneralProjectSettings : Object
    {
        public GeneralProjectSettings(ulong addr) : base(addr) { }
    ...
    {
        public HudSettings(ulong addr) : base(addr) { }
    ...
    {
        public AutoCompleteCommand(ulong addr) : base(addr) { }
    ...
    {
        public GameModeName(ulong addr) : base(addr) { }
