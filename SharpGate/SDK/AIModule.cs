...
namespace SDK.Script.AIModuleSDK
{
    ...
    public class EnvQueryGenerator_ProjectedPoints : EnvQueryGenerator
    {
        ...
        public EnvTraceData ProjectionDataOverride { get { return this[nameof(ProjectionDataOverride)].As<EnvTraceData>(); } set { this["ProjectionDataOverride"] = value; } }
    }
    ...
    {
        public RecastGraphWrapper(ulong addr) : base(addr) { }
