...
namespace SDK.Script.MovieSceneTracksSDK
{
    ...
    {
        public MovieSceneCameraShakeEvaluator(ulong addr) : base(addr) { }
    }
    ...
    {
        public ByteChannelEvaluatorSystem(ulong addr) : base(addr) { }
    }
    ...
    {
        public IntegerChannelEvaluatorSystem(ulong addr) : base(addr) { }
    }
    ...
    {
        public MovieSceneBoolPropertySystem(ulong addr) : base(addr) { }
    }
    ...
    {
        public MovieSceneBytePropertySystem(ulong addr) : base(addr) { }
    }
    ...
    {
        public MovieSceneColorPropertySystem(ulong addr) : base(addr) { }
    }
    ...
    {
        public MovieSceneDeferredComponentMovementSystem(ulong addr) : base(addr) { }
    }
    public class MovieSceneEnumPropertySystem : MovieScenePropertySystem
    {
        public MovieSceneEnumPropertySystem(ulong addr) : base(addr) { }
    }
    ...
    {
        public MovieSceneInitialValueSystem(ulong addr) : base(addr) { }
    }
    public class MovieSceneIntegerPropertySystem : MovieScenePropertySystem
    {
        public MovieSceneIntegerPropertySystem(ulong addr) : base(addr) { }
    }
    ...
    {
        public MovieScenePiecewiseBoolBlenderSystem(ulong addr) : base(addr) { }
    }
    public class MovieScenePiecewiseByteBlenderSystem : MovieSceneBlenderSystem
    {
        public MovieScenePiecewiseByteBlenderSystem(ulong addr) : base(addr) { }
    }
    public class MovieScenePiecewiseEnumBlenderSystem : MovieSceneBlenderSystem
    {
        public MovieScenePiecewiseEnumBlenderSystem(ulong addr) : base(addr) { }
    }
    ...
    {
        public MovieScenePiecewiseIntegerBlenderSystem(ulong addr) : base(addr) { }
    }
    ...
    {
        public MovieSceneVectorPropertySystem(ulong addr) : base(addr) { }
    }
