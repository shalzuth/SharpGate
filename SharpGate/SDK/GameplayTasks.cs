...
namespace SDK.Script.GameplayTasksSDK
{
    ...
    {
        public GameplayTask(ulong addr) : base(addr) { }
    ...
    {
        public GameplayTask_ClaimResource(ulong addr) : base(addr) { }
    ...
    {
        public GameplayTask_SpawnActor(ulong addr) : base(addr) { }
    ...
    {
        public GameplayTask_TimeLimitedExecution(ulong addr) : base(addr) { }
    ...
    {
        public GameplayTask_WaitDelay(ulong addr) : base(addr) { }
    ...
    {
        public GameplayTaskOwnerInterface(ulong addr) : base(addr) { }
    }
    public class GameplayTaskResource : Object
    {
        public GameplayTaskResource(ulong addr) : base(addr) { }
    ...
    {
        public GameplayTasksComponent(ulong addr) : base(addr) { }
    ...
    {
        public GameplayResourceSet(ulong addr) : base(addr) { }
    }
